...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Handling the automation of various ETL workflows and visualisation across business verticals at Grab, allowing product analytics teams to derive actionable insights from them}
    \resumeItem{Designing scalable systems using AWS and Azure services}
    \resumeItem{Technologies used: \textbf{ExpressJS, Flutter, Python, Typescript, AWS, Azure, Relational Databases}}
    \resumeItemListEnd
