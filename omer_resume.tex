...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Built features for data scientists and product leaders to visualise, collaborate and \textbf{derive actionable insights from metrics in real-time}, using Flutter}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Sole developer working on building models for Automatic Speech Recognition, Sentiment Analysis, Named Entity Recognition, Pseudonymisation, and Feature Detection}
      ...
      \resumeItem{Technologies used: \textbf{Python, Pytorch, Transformers, HuggingFace}}
      \resumeItemListEnd
