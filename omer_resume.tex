...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItem{Building an internal data platform and tooling in the Automated Scalable Insights team}
    \resumeItem{Handling the \textbf{automation of various ETL workflows and visualisations} across business verticals at Grab}
    \resumeItem{Building features for analysts to visualise, collaborate and derive actionable insights from metrics}
    \resumeItem{Designing scalable systems using AWS and Azure services}
    \resumeItem{Technologies used: \textbf{ExpressJS, Flutter, Python, Typescript, AWS, Azure, Databases}}
    \resumeItemListEnd
...
%-------------------------------------------
      \resumeProjectHeading
      {\textbf{AngelOwl Loyalties} $|$ \emph{Golang, Gin}}{January 2023 - Present}
      \resumeItemListStart
