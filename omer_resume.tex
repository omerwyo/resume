...
%-------------------------------------------
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Developed a \textbf{cross-platform mobile application in Flutter} to solve a Rubik's Cube based off of camera input from the device with the use of computer vision}
