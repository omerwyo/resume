...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
    {Quantitative Technologist Intern}{January 2024 - Present}
    ...
    \resumeItem{Built a tool that allows researchers and developers to intuitively create and manage compute clusters as well as submit, monitor and scale their computational workloads}
    \resumeItem{Refactored an existing MLOps tool, to increase productivity of colleagues, enhance modularity and scale compute more efficiently}
    \resumeItem{Technologies used: \textbf{Python, Ray, Linux}}
    \resumeItemListEnd
